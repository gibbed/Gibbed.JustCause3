...
{
    public class IntegerVariant : IVariant, RawPropertyContainerFile.IRawVariant, PropertyContainerFile.IRawVariant
    {
        private int _Value;
        ...
        {
            get { return RawPropertyContainerFile.VariantType.Integer; }
        }
